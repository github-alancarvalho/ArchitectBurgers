...
@RestController
public class PagamentoWebhookHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(PagamentoWebhookHandler.class);

    private final MercadoPagoPaymentListener mercadoPagoPaymentListener;
    private final TransactionManager transactionManager;

    @Autowired
    public PagamentoWebhookHandler(MercadoPagoPaymentListener mercadoPagoPaymentListener, TransactionManager transactionManager) {
